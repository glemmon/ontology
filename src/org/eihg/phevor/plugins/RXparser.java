...
{	
	...
	private static Node create_rx(GraphDatabaseService db, int child_code, String child_name, String type){
	...
	private static void _parse_record(GraphDatabaseService db, CSVRecord r, Node root, int child_level){
		...
		int child_code = Integer.parseInt(child_code_str);
		...
		int parent_code = Integer.parseInt(r.get(parent_code_label));
